...
sudo apt-get install gdebi-core cmake libxml2-dev libcurl4-openssl-dev libx11-dev mesa-common-dev libglu1-mesa-dev libssl-dev libgmp3-dev zlib1g-dev libjpeg-dev libpng-dev
sudo su - \
